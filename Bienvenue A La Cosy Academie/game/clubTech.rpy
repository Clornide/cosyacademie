...
init python:
    ...
    inner_pov_couloirs = ["Pourquoi il n'y pas de carte de l'Académie... Ça sert de lire une carte !",
            ...
            "J'en reviens pas qu'ils laissent faire des spectacles à ce Foulk. C'est sûrement subventionné par la région...",
            ...
            "Dépôt sauvage de peuneus interdit. Signé La direction.",
...
label club_tech:
    ...
    innerpov "Le secrétariat m'a indiqué de finaliser mon inscription auprès du club #tech afin d'obtenir ma Cosy carte d'élève... ce sera la preuve que je ne rêve pas !"
    ...
    innerpov "Ouh là. Ça a l'air tendu, je ne devrais peut-être pas les déranger, comme dirait Medoc ''un repli stratégique s'impose''. Demi-tour et fuyons !"
...
label .Clubtechmetalice:
    ...
    met "Écoute, ce n'est sûrement qu'une rumeur, rien de plus, mais il paraît qu'une nouvelle drogue circule à l'Académie. La DELTA FORCE mène l'enquête."
...
label .Clubtechfoulk:
    ...
    foulk "Tu l'as ? Steak.... Eric, Ramzy, grosse source d'inspiration... Ni vous, minou...? Non ?"
...
label .ChooseCouloir(count_couloir = 0):
    ...
    if count_couloir == 1:
        ...
        von "À droite, toujours à droite !"
