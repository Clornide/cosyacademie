label HardNight:
    ...
    show Medoc PosePoings Badboy at left
    ...
    show Medoc PosePoings Yeuxfermes Rougit at left
    ...
    show Medoc Topless Degoute with fade

    med "Oui... Voilà... Comme ça..."
    med "Un coup à gauche. Un coup à droite."

    show Medoc Topless Sourire
    ...
    show Medoc Topless Badboy Rougit at left with fade

    med "Mais enfin Moguri! Non, je peux pas..."

    show Moguri Topless Colere at right

    mog "Mais si fais moi confiance! Ça passe !"

    show Medoc Topless Colere Rougit at left

    med "Mais non!"
    mog "Mais si!"

    show Moguri Topless Sourire Rougit at right
